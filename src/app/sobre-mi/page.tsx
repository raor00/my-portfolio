    ...
    <div className="min-h-screen py-20 sm:py-24 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid lg:grid-cols-5 gap-12 mb-24 items-start"
        >
          {/* Avatar */}
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <p className="leading-relaxed" style={{ color: "rgba(0,0,0,0.55)" }}>
              {personalInfo.bio}
            </p>
        ...
        <div>
          <motion.div
            ...
            className="mb-12"
          >
            <span className="tech-label">{"// HABILIDADES"}</span>
            <h2
              className="text-2xl md:text-3xl font-bold mt-1"
              style={{ fontFamily: "var(--font-mono-display), monospace", color: "#0a0a0f" }}
            >
