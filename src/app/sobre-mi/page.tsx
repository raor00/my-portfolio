  ...
  return (
    <div className="min-h-screen py-20 sm:py-24 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <motion.span variants={fadeUp} className="tech-label">{"// ABOUT"}</motion.span>
          <motion.h1
            variants={fadeUp}
        ...
        <motion.div
          ...
          className="grid lg:grid-cols-5 gap-12 mb-20 sm:mb-24 items-start"
        >
          {/* Avatar */}
          <motion.div
            variants={fadeLeft}
        ...
        <div className="mb-20 sm:mb-24">
          ...
          >
            <motion.span variants={fadeUp} className="tech-label">{"// TRAYECTORIA"}</motion.span>
            <motion.h2
              variants={fadeUp}
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              {experience.map((exp, i) => (
                ...
                >
                  <div
                    className="absolute left-0 top-2 w-10 h-10 rounded-xl flex items-center justify-center"
        ...
        <div>
          <motion.div
            ...
            className="mb-10 sm:mb-12"
          >
            <motion.span variants={fadeUp} className="tech-label">{"// HABILIDADES"}</motion.span>
            <motion.h2
              variants={fadeUp}
              className="text-2xl md:text-3xl font-bold mt-1"
              style={{ fontFamily: "var(--font-mono-display), monospace", color: "#0a0a0f" }}
                  ...
                  {skills.filter((s) => s.category === cat).map((skill) => (
                    <div key={skill.name}>
                      <div className="flex justify-between items-center mb-1.5">
                        <span
                          className="text-xs"
                          style={{ fontFamily: "var(--font-mono-display), monospace", color: "rgba(0,0,0,0.65)" }}
                        >
                          {skill.name}
                        </span>
